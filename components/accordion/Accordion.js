...
function Accordion(props) {
  ...
  return (
    <div
      key={"main"+props.index}
      className={"accordion__section accrodion_no_" + props.index}
    >
      ...
      <div
        key={"parent"+props.index}
        ref={content}
        // style={{ minHeight: `${setHeight}` }}
        className="accordion__content"
      >
        <div className="card-body" key={"child"+props.index}>
          <ul className="zend-listing list-unstyled" key={props.index}>
            <li key={"grandchild"+props.index}>
              <p className="mb-0">Created: {props.created}</p>
            </li>
            <li key={"grandchild1"+props.index}>
